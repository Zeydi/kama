...
var layersList = [maposm, lyr_adm1, lyr_adm2, lyr_adm3, lyr_adm4, lyr_adm5];
...
var map = new ol.Map({
  ...
  view: new ol.View({
    ...
    center: new ol.geom.Point([9.37884, 34.240721])
...
var point = new ol.geom.Point(
  ol.proj.transform([9.37884, 34.240721], "EPSG:4326", "EPSG:3857")
);
...
$.getJSON("data/sites2g.geojson", function(data) {
  ...
  layerVectorPoint = new ol.layer.Heatmap({ source: source });
...
var marker = new ol.Overlay({
  element: document.getElementById("location"),
  ositioning: "center-center"
});
map.addOverlay(marker); // and bind it to the geolocation's position updates marker.bindTo('position', geolocation);
